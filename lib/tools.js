...
export const TOOLS = [
  {
    ...
    points: [
      'Answers cite the exact page — verify every claim',
      'Up to 500 pages / 50 MB per document',
      'Chat across several PDFs at once',
    ],
  ...
  },
  {
    ...
    audience: 'Teachers & coaching',
    points: [
      'MCQ, short, long, match & more — in sections with marks',
      'Verified answer key — a second AI pass re-checks it',
      'Print, export, or share as an auto-graded online test',
    ],
