...
const SECTIONS = [
      { id: "what", title: "What cookies we use", body: [
        "A cookie is a small file your browser stores on your device. We use a small number of essential cookies:",
        { ol: [
          "**Essential** — to keep you signed in, keep the service secure, and remember your cookie choice. These are always on.",
        ]},
...
export const metadata = {
  alternates: { canonical: '/legal/cookies' }, title: "Cookie Policy \u2014 CHATWITHPDFAI" };
